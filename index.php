                ...
                <div class="container"> 
                    <center>
                        <div id="banner_content">
                            <h1>We bring style to life.</h1>
                            <p>Premium Picks at 55% OFF</p>
                            <br/>
                    ...
                    <div class="col-sm-4">
                        <a href="products.php#watches" >
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h3>Jewelery</h3>
                                    <p>Beautiful jewelery from the best brands.</p>
                                </div>
                            </div> 
                        </a>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <a href="products.php#shirts" >
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h3>Apparel</h3>
                                    <p>Our exquisite collection of Apparel.</p>
                                </div>
                            </div>
                        </a>
                    </div>
