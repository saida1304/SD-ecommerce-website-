    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="jumbotron home-spacer" id="products-jumbotron">
                <h1>Welcome to our SD Store!</h1>
                <p>We have the best Beauty Gagdets, Jewelery and Apparel for you. No need to hunt around, we have all in one place.</p>
